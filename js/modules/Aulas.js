var app = angular.module("AppAulas", []);
...
$scope.apartarAula = function(idAula) {// metodo encargado de crear la reserva del reservable en el base
...
$scope.consultarAula= function(){// metodo encargado de realizar la consulta de los equipos disponibles en la fecha y horas indicadas 
  $scope.btnConsultar=true;
    $scope.btnConsultar=true;
